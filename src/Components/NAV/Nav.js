                    ...
                    <div className='container justify-content-center h-100 w-100'>
                        <div>
                            ...
                            <div className='d-inline float-right p-0 p-sm-2'>
                                <div className='d-inline text-white text-decoration-none font-weight-normal'><Link to='/writetous' href='#' className='white-ic nav-tell'><i className='far fa-envelope px-2 env-small text-white'></i>luxeapartments25@gmail.com</Link></div>
                            </div>
                        </div>
                    </div>
                </div>
