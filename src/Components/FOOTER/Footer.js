                       ...
                       <div className='d-inline-flex w-100 h-100'>
                           <MDBRow className='flex-wrap w-100'>
                               ...
                               <MDBCol className='col-12 col-sm-6 col-md-6 col-lg-3 col-xl-3 pt-4 py-sm-5 pr-0 px-0 pl-lg-0 pl-md-3 pl-sm-3 pb-0'>
                                   ...
                                   <MDBNavLink to="/category/Studio apartments" className='p-0 m-0'><p className='pl-4 pl-xl-5 pl-lg-5 pl-md-0 pl-sm-0'><a className='footer-info white-ic'>Studio apartments</a></p></MDBNavLink>
                                   <MDBNavLink to="/category/One-room apartments" className='p-0 m-0'><p className='pl-4 pl-xl-5 pl-lg-5 pl-md-0 pl-sm-0'><a className='footer-info white-ic'>One-room apartments</a></p></MDBNavLink>
                                   <MDBNavLink to="/category/Studio apartments" className='p-0 m-0'><p className='pl-4 pl-xl-5 pl-lg-5 pl-md-0 pl-sm-0'><a href="/category/Two-room apartments" className='footer-info white-ic'>Double-room apartments</a></p></MDBNavLink>
                                   <MDBNavLink to="/category/Studio apartments" className='p-0 m-0'><p className='pl-4 pl-xl-5 pl-lg-5 pl-md-0 pl-sm-0'><a href='#' className='footer-info white-ic'>Three-room apartments</a></p></MDBNavLink>
                                   <MDBNavLink to="/category/Studio apartments" className='p-0 m-0'><p className='pl-4 pl-xl-5 pl-lg-5 pl-md-0 pl-sm-0'><a href='#' className='footer-info white-ic'>Three-room apartments</a></p></MDBNavLink>
                                   <MDBNavLink to="/category/Studio apartments" className='p-0 m-0'><p className='pl-4 pl-xl-5 pl-lg-5 pl-md-0 pl-sm-0'><a href='#' className='footer-info white-ic'>Apartments in Center</a></p></MDBNavLink>
                                   <MDBNavLink to="/category/Studio apartments" className='p-0 m-0'><p className='pl-4 pl-xl-5 pl-lg-5 pl-md-0 pl-sm-0'><a href='#' className='footer-info white-ic'>Arkadia area apartments</a></p></MDBNavLink>
                                   <MDBNavLink to="/category/Studio apartments" className='p-0 m-0'><p className='pl-4 pl-xl-5 pl-lg-5 pl-md-0 pl-sm-0'><a href='#' className='footer-info white-ic'>Nemo area apartments</a></p></MDBNavLink>
                               </MDBCol>
